...
class ProductController extends Controller
{
    ...
    public function UpdateProduct(Request $request) {
        ...
        return redirect()->route('allproducts')->with('message','Product Details Update Successfully');
    }
    ...
    Public function DeleteProduct($id) {
        ...
        return redirect()->route('allproducts')->with('message','Product Delete Update Successfully');
    }
}
